...
kmi_props_setattr(kmi.properties, 'name', 'VIEW3D_MT_add')
...
kmi = km.keymap_items.new('transform.group', 'G', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('view3d.game_start', 'INSERT', 'PRESS')
kmi = km.keymap_items.new('object.multires_subdivide', 'D', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'modifier', 'Multires')
kmi = km.keymap_items.new('object.modifier_add', 'V', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('wm.call_menu', 'A', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'name', 'VIEW3D_MT_edit_curve_add')
...
kmi = km.keymap_items.new('curve.select_more', 'PERIOD', 'PRESS')
kmi = km.keymap_items.new('curve.select_less', 'COMMA', 'PRESS')
...
kmi = km.keymap_items.new('curve.spline_type_set', 'C', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('mesh.loop_select', 'SELECTMOUSE', 'PRESS', shift=True, ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'deselect', False)
...
kmi = km.keymap_items.new('mesh.edgering_select', 'RIGHTMOUSE', 'PRESS', shift=True, alt=True)
kmi_props_setattr(kmi.properties, 'extend', True)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi_props_setattr(kmi.properties, 'ring', True)
...
kmi = km.keymap_items.new('mesh.merge', 'Q', 'PRESS', alt=True)
kmi = km.keymap_items.new('mesh.edge_face_add', 'F', 'PRESS', alt=True)
kmi = km.keymap_items.new('wm.call_menu', 'A', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'name', 'VIEW3D_MT_mesh_add')
...
kmi = km.keymap_items.new('transform.edge_slide', 'J', 'PRESS')
...
kmi = km.keymap_items.new('mesh.vert_connect', 'F', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('mesh.bevel', 'B', 'PRESS', shift=True, alt=True)
kmi_props_setattr(kmi.properties, 'vertex_only', False)
kmi = km.keymap_items.new('mesh.shortest_path_select', 'S', 'PRESS')
...
kmi = km.keymap_items.new('mesh.rip_move', 'X', 'PRESS', shift=True)
kmi = km.keymap_items.new('mesh.duplicate_move', 'D', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('mesh.rip_move_fill', 'Z', 'PRESS', shift=True)
kmi = km.keymap_items.new('mesh.separate', 'P', 'PRESS', alt=True)
kmi = km.keymap_items.new('wm.context_toggle_enum', 'B', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.proportional_edit')
kmi_props_setattr(kmi.properties, 'value_1', 'DISABLED')
kmi_props_setattr(kmi.properties, 'value_2', 'ENABLED')
kmi = km.keymap_items.new('mesh.bisect', 'B', 'PRESS', shift=True)
kmi = km.keymap_items.new('mesh.offset_edge_loops_slide', 'O', 'PRESS')
kmi = km.keymap_items.new('occlude.geometry', 'V', 'PRESS')
# Map Metaball
...
kmi_props_setattr(kmi.properties, 'value_1', 'DISABLED')
kmi_props_setattr(kmi.properties, 'value_2', 'CONNECTED')
kmi = km.keymap_items.new('particle.comb_select', 'C', 'PRESS')
kmi = km.keymap_items.new('particle.smooth_select', 'S', 'PRESS')
kmi = km.keymap_items.new('particle.none_select', 'N', 'PRESS', shift=True)
kmi = km.keymap_items.new('particle.add_select', 'D', 'PRESS')
kmi = km.keymap_items.new('particle.length_select', 'I', 'PRESS')
kmi = km.keymap_items.new('particle.puff_select', 'P', 'PRESS')
kmi = km.keymap_items.new('particle.cut_select', 'C', 'PRESS', shift=True)
kmi = km.keymap_items.new('particle.weight_select', 'W', 'PRESS', shift=True)
kmi = km.keymap_items.new('transform.translate', 'W', 'PRESS')
kmi = km.keymap_items.new('transform.rotate', 'E', 'PRESS')
kmi = km.keymap_items.new('transform.resize', 'R', 'PRESS')
...
kmi = km.keymap_items.new('node.backimage_move', 'MIDDLEMOUSE', 'PRESS')
kmi = km.keymap_items.new('node.backimage_zoom', 'MINUS', 'PRESS')
kmi_props_setattr(kmi.properties, 'factor', 0.833329975605011)
kmi = km.keymap_items.new('node.backimage_zoom', 'EQUAL', 'PRESS')
...
kmi = km.keymap_items.new('node.link_make', 'F', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('node.group_edit', 'G', 'PRESS')
...
kmi = km.keymap_items.new('node.backimage_fit', 'F', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('node.view_selected', 'F', 'PRESS')
kmi = km.keymap_items.new('node.duplicate_move', 'D', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('node.detach_translate_attach', 'S', 'PRESS')
kmi = km.keymap_items.new('node.move_detach_links', 'D', 'PRESS', alt=True)
kmi = km.keymap_items.new('node.join', 'S', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('node.select_link_viewer', 'ACCENT_GRAVE', 'PRESS')
kmi = km.keymap_items.new('node.nw_emission_viewer', 'ACCENT_GRAVE', 'PRESS')
...
kmi = km.keymap_items.new('node.tree_path_parent', 'U', 'PRESS')
...
kmi = km.keymap_items.new('wm.context_set_enum', 'ONE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.tree_type')
kmi_props_setattr(kmi.properties, 'value', 'ShaderNodeTree')
kmi = km.keymap_items.new('wm.context_set_enum', 'TWO', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.tree_type')
kmi_props_setattr(kmi.properties, 'value', 'CompositorNodeTree')
kmi = km.keymap_items.new('wm.context_set_enum', 'THREE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.tree_type')
kmi_props_setattr(kmi.properties, 'value', 'TextureNodeTree')
kmi = km.keymap_items.new('wm.context_set_enum', 'ONE', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.shader_type')
kmi_props_setattr(kmi.properties, 'value', 'OBJECT')
kmi = km.keymap_items.new('wm.context_set_enum', 'TWO', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.shader_type')
kmi_props_setattr(kmi.properties, 'value', 'WORLD')
kmi = km.keymap_items.new('wm.context_set_enum', 'THREE', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.shader_type')
kmi_props_setattr(kmi.properties, 'value', 'LINESTYLE')
...
kmi = km.keymap_items.new('wm.context_toggle', 'B', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('gpencil.brush_paint', 'LEFTMOUSE', 'PRESS', key_modifier='V')
kmi_props_setattr(kmi.properties, 'wait_for_input', False)
kmi = km.keymap_items.new('wm.radial_control', 'B', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('gpencil.select_border', 'M', 'PRESS', shift=True)
kmi = km.keymap_items.new('gpencil.select_lasso', 'MIDDLEMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('gpencil.select_lasso', 'MIDDLEMOUSE', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('gpencil.select_lasso', 'MIDDLEMOUSE', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi = km.keymap_items.new('gpencil.select', 'SELECTMOUSE', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('gpencil.select_more', 'PERIOD', 'PRESS', shift=True)
kmi = km.keymap_items.new('gpencil.select_less', 'COMMA', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('gpencil.reveal', 'H', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('gpencil.hide', 'H', 'PRESS')
kmi_props_setattr(kmi.properties, 'unselected', False)
kmi = km.keymap_items.new('gpencil.hide', 'H', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'unselected', True)
kmi = km.keymap_items.new('gpencil.selection_opacity_toggle', 'H', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('gpencil.layer_isolate', 'I', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'affect_visibility', True)
...
kmi = km.keymap_items.new('view3d.viewnumpad', 'NUMPAD_8', 'PRESS')
...
kmi = km.keymap_items.new('view3d.clip_border', 'B', 'PRESS')
...
kmi = km.keymap_items.new('view3d.object_as_camera', 'C', 'PRESS')
kmi = km.keymap_items.new('wm.context_toggle_enum', 'EIGHT', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.viewport_shade')
...
kmi = km.keymap_items.new('transform.shrink_fatten', 'I', 'PRESS')
kmi = km.keymap_items.new('transform.vert_slide', 'K', 'PRESS')
kmi = km.keymap_items.new('view3d.layers', 'H', 'PRESS')
kmi_props_setattr(kmi.properties, 'nr', 0)
kmi = km.keymap_items.new('wm.context_toggle_enum', 'ACCENT_GRAVE', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.pivot_point')
kmi_props_setattr(kmi.properties, 'value_1', 'MEDIAN_POINT')
kmi_props_setattr(kmi.properties, 'value_2', 'CURSOR')
kmi = km.keymap_items.new('wm.context_toggle_enum', 'ONE', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.snap_element')
kmi_props_setattr(kmi.properties, 'value_1', 'VERTEX')
kmi_props_setattr(kmi.properties, 'value_2', 'VERTEX')
kmi = km.keymap_items.new('wm.context_toggle_enum', 'TWO', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.snap_element')
kmi_props_setattr(kmi.properties, 'value_1', 'EDGE')
kmi_props_setattr(kmi.properties, 'value_2', 'EDGE')
kmi = km.keymap_items.new('wm.context_toggle_enum', 'THREE', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.snap_element')
kmi_props_setattr(kmi.properties, 'value_1', 'FACE')
kmi_props_setattr(kmi.properties, 'value_2', 'FACE')
kmi = km.keymap_items.new('wm.context_toggle_enum', 'ACCENT_GRAVE', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.snap_element')
kmi_props_setattr(kmi.properties, 'value_1', 'INCREMENT')
kmi_props_setattr(kmi.properties, 'value_2', 'INCREMENT')
kmi = km.keymap_items.new('wm.context_toggle_enum', 'FOUR', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.snap_element')
kmi_props_setattr(kmi.properties, 'value_1', 'VOLUME')
kmi_props_setattr(kmi.properties, 'value_2', 'VOLUME')
kmi = km.keymap_items.new('view3d.pastebuffer', 'V', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('view3d.copybuffer', 'C', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('view3d.clear_render_border', 'B', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('view3d.camera_to_view', 'C', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('view3d.view_roll', 'PAGE_UP', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'type', 'LEFT')
kmi = km.keymap_items.new('view3d.view_roll', 'PAGE_DOWN', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'type', 'RIGHT')
...
kmi = km.keymap_items.new('transform.rotate', 'E', 'PRESS')
kmi = km.keymap_items.new('transform.resize', 'R', 'PRESS')
kmi = km.keymap_items.new('camera.lock', 'L', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('wm.context_toggle', 'TAB', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.use_snap')
kmi = km.keymap_items.new('uv.select_more', 'NONE', 'PRESS')
kmi = km.keymap_items.new('uv.select_more', 'PERIOD', 'PRESS', shift=True)
kmi = km.keymap_items.new('uv.select_less', 'COMMA', 'PRESS', shift=True)
kmi = km.keymap_items.new('uv.select_split', 'S', 'PRESS')
kmi = km.keymap_items.new('uv.pack_islands', 'I', 'PRESS')

# Map Object Non-modal
km = kc.keymaps.new('Object Non-modal', space_type='EMPTY', region_type='WINDOW', modal=False)

kmi = km.keymap_items.new('object.mode_set', 'ONE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'EDIT')
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi = km.keymap_items.new('object.mode_set', 'TWO', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'SCULPT')
kmi = km.keymap_items.new('object.mode_set', 'THREE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'TEXTURE_PAINT')
kmi = km.keymap_items.new('object.mode_set', 'FOUR', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'WEIGHT_PAINT')
kmi = km.keymap_items.new('object.mode_set', 'FIVE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'POSE')
kmi = km.keymap_items.new('object.mode_set', 'ACCENT_GRAVE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'OBJECT')
kmi = km.keymap_items.new('object.origin_set', 'C', 'PRESS', shift=True)
kmi = km.keymap_items.new('object.mode_set', 'SIX', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'PARTICLE_EDIT')
...
kmi_props_setattr(kmi.properties, 'name', 'VIEW3D_MT_file_open_recent')
...
kmi = km.keymap_items.new('wm.context_set_enum', 'F3', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'NODE_EDITOR')
kmi = km.keymap_items.new('wm.context_set_enum', 'F6', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'NLA_EDITOR')
kmi = km.keymap_items.new('wm.context_set_enum', 'F1', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'VIEW_3D')
kmi = km.keymap_items.new('wm.context_set_enum', 'F2', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'IMAGE_EDITOR')
kmi = km.keymap_items.new('wm.context_set_enum', 'F4', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'SEQUENCE_EDITOR')
kmi = km.keymap_items.new('wm.context_set_enum', 'F7', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
...
kmi = km.keymap_items.new('wm.context_set_enum', 'F8', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'TIMELINE')
kmi = km.keymap_items.new('wm.context_set_enum', 'F5', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'DOPESHEET_EDITOR')
kmi = km.keymap_items.new('wm.context_set_enum', 'F9', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
kmi_props_setattr(kmi.properties, 'value', 'CONSOLE')
kmi = km.keymap_items.new('wm.context_set_enum', 'F10', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'area.type')
...
kmi = km.keymap_items.new('screen.repeat_history', 'G', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('render.play_rendered_anim', 'F11', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('render.view_show', 'F12', 'PRESS', shift=True)
...
kmi_props_setattr(kmi.properties, 'mode', 'OBJECT')
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('image.save_as', 'S', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('image.external_edit', 'E', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('wm.context_set_enum', 'ONE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.mode')
kmi_props_setattr(kmi.properties, 'value', 'VIEW')
kmi = km.keymap_items.new('wm.context_set_enum', 'TWO', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.mode')
kmi_props_setattr(kmi.properties, 'value', 'PAINT')
kmi = km.keymap_items.new('wm.context_set_enum', 'THREE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.mode')
kmi_props_setattr(kmi.properties, 'value', 'MASK')
...
kmi = km.keymap_items.new('paint.grab_clone', 'ACCENT_GRAVE', 'PRESS')
kmi = km.keymap_items.new('paint.sample_color', 'ACCENT_GRAVE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'paint_mode', 'TEXTURE_PAINT')
...
kmi_props_setattr(kmi.properties, 'paint_mode', 'TEXTURE_PAINT')
kmi_props_setattr(kmi.properties, 'texture_paint_tool', 'CLONE')
kmi = km.keymap_items.new('paint.brush_select', 'S', 'PRESS')
kmi_props_setattr(kmi.properties, 'paint_mode', 'TEXTURE_PAINT')
kmi_props_setattr(kmi.properties, 'texture_paint_tool', 'SOFTEN')
kmi = km.keymap_items.new('paint.brush_select', 'R', 'PRESS')
kmi_props_setattr(kmi.properties, 'texture_paint_tool', 'SMEAR')
kmi = km.keymap_items.new('paint.brush_select', 'M', 'PRESS')
kmi_props_setattr(kmi.properties, 'texture_paint_tool', 'MASK')
kmi = km.keymap_items.new('paint.brush_select', 'G', 'PRESS')
kmi_props_setattr(kmi.properties, 'paint_mode', 'TEXTURE_PAINT')
kmi_props_setattr(kmi.properties, 'texture_paint_tool', 'FILL')
kmi = km.keymap_items.new('paint.symmetry_x', 'X', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_CHARACTER')
kmi = km.keymap_items.new('console.delete', 'X', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_CHARACTER')
kmi = km.keymap_items.new('console.delete', 'DEL', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'type', 'NEXT_WORD')
kmi = km.keymap_items.new('console.delete', 'X', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_WORD')
...
kmi = km.keymap_items.new('console.indent', 'TAB', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('paint.mask_flood_fill', 'LEFTMOUSE', 'CLICK', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'mode', 'VALUE')
kmi = km.keymap_items.new('paint.mask_flood_fill', 'RIGHTMOUSE', 'CLICK', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'mode', 'INVERT')
kmi = km.keymap_items.new('paint.hide_show', 'H', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'action', 'HIDE')
...
kmi_props_setattr(kmi.properties, 'paint_mode', 'SCULPT')
kmi_props_setattr(kmi.properties, 'sculpt_tool', 'THUMB')
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('paint.brush_select', 'T', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'paint_mode', 'SCULPT')
kmi_props_setattr(kmi.properties, 'sculpt_tool', 'SCRAPE')
kmi = km.keymap_items.new('paint.mask_lasso_gesture', 'MIDDLEMOUSE', 'PRESS', shift=True, ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'value', 0.0)
kmi = km.keymap_items.new('paint.brush_select', 'G', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'paint_mode', 'SCULPT')
kmi_props_setattr(kmi.properties, 'sculpt_tool', 'ROTATE')
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi = km.keymap_items.new('sculpt.symmetry_x', 'X', 'PRESS')
kmi = km.keymap_items.new('sculpt.dynamic_topology_toggle', 'Q', 'PRESS')
kmi = km.keymap_items.new('paint.brush_select', 'R', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'sculpt_tool', 'NUDGE')
kmi = km.keymap_items.new('paint.brush_select', 'R', 'PRESS', shift=True)
...
kmi_props_setattr(kmi.properties, 'axis_range', False)
kmi_props_setattr(kmi.properties, 'include_handles', False)
kmi = km.keymap_items.new('graph.select_more', 'PERIOD', 'PRESS')
kmi = km.keymap_items.new('graph.select_less', 'COMMA', 'PRESS')
kmi = km.keymap_items.new('graph.frame_jump', 'J', 'PRESS')
kmi = km.keymap_items.new('graph.snap', 'S', 'PRESS', shift=True)
kmi = km.keymap_items.new('graph.mirror', 'M', 'PRESS', shift=True)
kmi = km.keymap_items.new('graph.handle_type', 'RIGHTMOUSE', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('graph.select_lasso', 'MIDDLEMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('graph.select_lasso', 'MIDDLEMOUSE', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi = km.keymap_items.new('graph.select_lasso', 'MIDDLEMOUSE', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('graph.delete', 'S', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('paint.weight_sample', 'ACCENT_GRAVE', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'weight_paint_tool', 'MIX')
kmi = km.keymap_items.new('paint.brush_select', 'S', 'PRESS')
kmi_props_setattr(kmi.properties, 'paint_mode', 'WEIGHT_PAINT')
kmi_props_setattr(kmi.properties, 'weight_paint_tool', 'BLUR')
...
kmi = km.keymap_items.new('armature.merge', 'Q', 'PRESS', alt=True)
kmi = km.keymap_items.new('wm.call_menu', 'RIGHTMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'name', 'VIEW3D_MT_bone_options_toggle')
kmi = km.keymap_items.new('armature.layers_show_all', 'H', 'PRESS')
...
kmi = km.keymap_items.new('armature.split', 'C', 'PRESS', alt=True)
kmi = km.keymap_items.new('armature.switch_direction', 'D', 'PRESS')
kmi = km.keymap_items.new('armature.extrude_move', 'X', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('screen.animation_play', 'V', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'reverse', True)
kmi_props_setattr(kmi.properties, 'sync', False)
...
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('pose.select_parent', 'P', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new_modal('SUBTRACT', 'PAGE_DOWN', 'PRESS')
kmi = km.keymap_items.new_modal('SUBTRACT', 'NUMPAD_MINUS', 'PRESS')
kmi = km.keymap_items.new_modal('ADD', 'PAGE_UP', 'PRESS')
...
kmi = km.keymap_items.new('graph.extrapolation_type', 'RIGHTMOUSE', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('anim.channels_find', 'F', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('graph.hide', 'H', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new_modal('BACKWARD', 'W', 'PRESS', any=True)
...
kmi = km.keymap_items.new_modal('BACKWARD_STOP', 'W', 'RELEASE', any=True)
...
kmi_props_setattr(kmi.properties, 'axis_range', False)
kmi = km.keymap_items.new('action.select_more', 'PERIOD', 'PRESS')
kmi = km.keymap_items.new('action.select_less', 'COMMA', 'PRESS')
...
kmi = km.keymap_items.new('action.delete', 'S', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('info.select_pick', 'SELECTMOUSE', 'CLICK')
kmi = km.keymap_items.new('info.select_all_toggle', 'MIDDLEMOUSE', 'CLICK')
...
kmi = km.keymap_items.new('mask.new', 'N', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('wm.call_menu', 'A', 'PRESS', shift=True)
...
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi = km.keymap_items.new('mask.select_border', 'Q', 'PRESS')
kmi = km.keymap_items.new('mask.select_circle', 'C', 'PRESS')
kmi = km.keymap_items.new('mask.select_lasso', 'EVT_TWEAK_M', 'ANY')
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi = km.keymap_items.new('mask.select_lasso', 'EVT_TWEAK_M', 'ANY', shift=True)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('mask.select_more', 'PERIOD', 'PRESS')
kmi = km.keymap_items.new('mask.select_less', 'COMMA', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('mask.cyclic_toggle', 'C', 'PRESS', shift=True)
kmi = km.keymap_items.new('mask.slide_point', 'ACTIONMOUSE', 'PRESS')
kmi = km.keymap_items.new('mask.handle_type_set', 'V', 'PRESS')
kmi = km.keymap_items.new('mask.normals_make_consistent', 'N', 'PRESS', alt=True)
kmi = km.keymap_items.new('mask.parent_set', 'P', 'PRESS')
...
kmi = km.keymap_items.new('mask.duplicate_move', 'D', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('uv.cursor_set', 'ACTIONMOUSE', 'PRESS')
kmi = km.keymap_items.new('transform.translate', 'EVT_TWEAK_S', 'ANY')
kmi = km.keymap_items.new('transform.rotate', 'E', 'PRESS')
kmi = km.keymap_items.new('transform.transform', 'D', 'PRESS')
kmi_props_setattr(kmi.properties, 'mode', 'MASK_SHRINKFATTEN')
kmi = km.keymap_items.new('mask.select_lasso', 'MIDDLEMOUSE', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('mask.feather_weight_clear', 'D', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('time.view_frame', 'F', 'PRESS')
# Map Face Mask
...
kmi = km.keymap_items.new('nla.meta_add', 'G', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('nla.split', 'C', 'PRESS')
...
kmi = km.keymap_items.new('nla.fmodifier_add', 'C', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('transform.transform', 'W', 'PRESS')
kmi = km.keymap_items.new('transform.transform', 'EVT_TWEAK_M', 'ANY')
kmi = km.keymap_items.new('transform.transform', 'R', 'PRESS')
kmi_props_setattr(kmi.properties, 'mode', 'TIME_SCALE')
...
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('sequencer.cut', 'C', 'PRESS')
kmi_props_setattr(kmi.properties, 'type', 'SOFT')
kmi = km.keymap_items.new('sequencer.cut', 'X', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'unselected', True)
kmi = km.keymap_items.new('sequencer.unmute', 'D', 'DOUBLE_CLICK')
kmi_props_setattr(kmi.properties, 'unselected', False)
kmi = km.keymap_items.new('sequencer.unmute', 'H', 'PRESS', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'unselected', True)
kmi = km.keymap_items.new('sequencer.lock', 'L', 'PRESS', alt=True)
kmi = km.keymap_items.new('sequencer.unlock', 'L', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('sequencer.meta_toggle', 'G', 'PRESS')
...
kmi = km.keymap_items.new('marker.add', 'M', 'PRESS')
kmi = km.keymap_items.new('sequencer.gap_insert', 'I', 'PRESS')
kmi = km.keymap_items.new('sequencer.gap_remove', 'I', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'all', False)
kmi = km.keymap_items.new('marker.rename', 'M', 'PRESS', ctrl=True)
...
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_CHARACTER')
kmi = km.keymap_items.new('text.delete', 'X', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_CHARACTER')
kmi = km.keymap_items.new('text.delete', 'DEL', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'type', 'NEXT_WORD')
kmi = km.keymap_items.new('text.delete', 'X', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_WORD')
...
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_OR_SELECTION')
kmi = km.keymap_items.new('font.delete', 'X', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'type', 'PREVIOUS_OR_SELECTION')
...
kmi = km.keymap_items.new('font.text_insert', 'TEXTINPUT', 'NOTHING')
