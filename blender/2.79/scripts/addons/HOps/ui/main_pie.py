...
class HOpsMainPie(bpy.types.Menu):
    ...
    def drawpie_only_with_AP_as_active_object(self, layout, object):
        pie = self.layout.menu_pie()
        pie.operator("hops.remove_merge", text = "(R) merge")#, icon_value=get_icon_id("Merge"))
        pie.separator()
    ...
    def drawpie_with_active_object_and_other_mesh_for_softmerge(self, layout, active_object, other_object):
        ...
        pie.operator("hops.remove_merge", text = "(R) merge")#, icon_value=get_icon_id("CSharpen"))
        pie.separator()
    ...
    def draw_edit_mode_pie(self, layout, object):
        ...
        pie.separator()
        #bot
        pie.operator("bevelandsharp1.objects", text = "Make SSharp")#, icon_value = get_icon_id("MakeSharpE"))
        #top
        pie.separator()
        #top L
        pie.separator()
