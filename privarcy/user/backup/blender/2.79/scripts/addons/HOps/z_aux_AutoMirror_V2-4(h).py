...
bl_info = {
    "name": "Auto Mirror(h)",
    "description": "Super fast cutting and mirroring for mesh(e)",
    "author": "Lapineige",
    "version": (2, 4),
    "blender": (2, 7, 1),
...
bpy.types.Scene.AutoMirror_orientation = bpy.props.EnumProperty(items = [("negative", "Negative", "", 1),("positive", "Positive", "", 2)], description="Choose the side along the axis of the editable part (+/- coordinates)")
...
bpy.types.Scene.AutoMirror_toggle_edit = bpy.props.BoolProperty(default= False, description="If not in edit mode, change mode to edit")
